...
public class ex02 {
	...
	public static void main(String[] args) {
        int N = 5;
        System.out.println(minBatteryUsage(N)); // Should print 2
    }

    public static int minBatteryUsage(int N) {
        int batteryUsage = 0;
        while (N > 0) {
            batteryUsage += N % 2;  // Adds 1 if N is odd (i.e., if there's a 1 in the current least significant bit)
            N /= 2;  // Right shift the binary representation of N by 1
        }
        return batteryUsage;
    }
}
